defmodule TrackerWeb.TasksControllerTest do
  use TrackerWeb.ConnCase

  alias Tracker.Social

  @create_attrs %{body: "some body", time_spent: 42, title: "some title"}
  @update_attrs %{body: "some updated body", time_spent: 43, title: "some updated title"}
  @invalid_attrs %{body: nil, time_spent: nil, title: nil}

  def fixture(:tasks) do
    {:ok, tasks} = Social.create_tasks(@create_attrs)
    tasks
  end
